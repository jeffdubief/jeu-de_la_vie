...
# taille de la grille
largeur = input("nombre de case en largeur?")
width = int(largeur)*10
longueur = input("nombre de case en longueur?")
height = int(longueur)*10

# taille des cellules
c = 10

# nombre de cycles de base (0 = 1 seul cycle puisqu'on vérifie la variable en fin de boucle)
cycles = 0
...
# programme "principal"
fen1 = Tk(className="Jeu de la vie")
...
entree = Entry(fen1)
entree.bind("<Return>", chgNbrCycles)
entree.pack(side=RIGHT)
chaine = Label(fen1)
chaine.configure(text="Nombre de cycles :")
